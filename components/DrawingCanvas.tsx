...
export default function DrawingCanvas({ onDraw }: DrawingCanvasProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="relative p-1 bg-white rounded-xl border border-slate-200 shadow-sm">
        <canvas
          ref={canvasRef}
      ...
      <button
        onClick={clearCanvas}
        className="flex items-center gap-2 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 active:bg-slate-100 text-slate-800 border border-slate-200 rounded-lg transition-colors font-medium shadow-sm"
      >
